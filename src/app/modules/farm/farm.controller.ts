...
const getMyFarm = catchAsync(async (req: Request, res: Response) => {
  const userId = getUserObjectId(req);
...
const updateMyFarm = catchAsync(async (req: Request, res: Response) => {
  const userId = getUserObjectId(req);
  const { farmId } = req.params as { farmId: string };
  const farmObjectId = getFarmObjectId(farmId);
...
const deleteMyFarm = catchAsync(async (req: Request, res: Response) => {
  const userId = getUserObjectId(req);
  const { farmId } = req.params as { farmId: string };
  const farmObjectId = getFarmObjectId(farmId);
